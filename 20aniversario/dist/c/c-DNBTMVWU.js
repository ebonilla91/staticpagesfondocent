import{a as v,b as m}from"https://d1id5eheivyv24.cloudfront.net/98c7974b/dist/c/c-DQLWRJ6O.js";import{a as u,b}from"https://d1id5eheivyv24.cloudfront.net/98c7974b/dist/c/c-3ZELX36Q.js";import{a as d}from"https://d1id5eheivyv24.cloudfront.net/98c7974b/dist/c/c-IDSWT3EJ.js";var p,S,h=d(()=>{"use strict";b();p=(a,i=[])=>{let o={};return Object.keys(a).forEach(e=>{let t=[...i,e].join("."),n=a[e];["string","number","boolean"].includes(typeof n)?o[t]=a[e]:typeof n=="object"&&n!==null&&(o={...o,...p(n,[...i,e])})}),o},S=(a,i)=>{if(!(window.RM.common.isDownloadedSource&&!window.RM.common.homepageRewrite)){let e={...p(i),userAgent:window.navigator.userAgent,"event.timingMs":Date.now()-window.performance.timing.navigationStart,"event.timestamp":Date.now()};u.post("/api/proxy/honeycomb",{event:e,dataset:a})}}});function g(a,i,o,e){o&&(a.preventDefault?a.preventDefault():event.returnValue=!1);var t=a.detail||-a.wheelDelta/40;t*=19,typeof e=="number"&&!isNaN(e)&&(t*=e),i.scrollBy?i.scrollBy(0,t):i.scrollTop+=t}var r,f,B,w=d(()=>{"use strict";r=["DOMMouseScroll","mousewheel"];f=function(a,i,o,e){a||(a=document),i||(i=window),typeof o!="boolean"&&(o=!0);var t,n,c,l=function(s){s=s||window.event,g(s,i,o,e)};return(t=a.addEventListener)?(t.call(a,r[0],l,!1),t.call(a,r[1],l,!1)):(t=a.attachEvent)&&t.call(a,"on"+r[1],l),(n=a.removeEventListener)?c=function(){n.call(a,r[0],l,!1),n.call(a,r[1],l,!1)}:(n=a.detachEvent)&&(c=function(){n.call(a,"on"+r[1],l)}),{restore:c}},B=f});m();var P={"template-viewer-cart-sidebar":v`
